...
import sysPageBar from './components/sysPageBar.vue'
import sysCopyText from './components/sysCopyText.vue'
import emptyImage from '@/assets/images/empty.svg'
import detail from './configDetails.vue'
import type { ConfigGroupListVo } from '~/base/api/configGroup'
import { deleteByIds, page } from '~/base/api/configGroup'
...
import ConfigForm from './groupForm.vue'
