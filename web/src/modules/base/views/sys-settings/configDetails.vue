...
import SettingForm from './components/configDetailsForm.vue'
import Create from './components/create.vue'
import type { ConfigGroupListVo, ConfigVo } from '~/base/api/configGroup.ts'
import { batchUpdate, details } from '~/base/api/config.ts'
