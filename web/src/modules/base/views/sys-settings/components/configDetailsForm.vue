...
import type { ConfigItem } from '../utils/type.ts'
import { buildRenderProps, renderInputTypeComponent, shouldShowDataButton } from '../utils/tools.tsx'
import { deleteByKey } from '~/base/api/config.ts'
