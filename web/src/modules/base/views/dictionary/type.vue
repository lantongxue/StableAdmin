...
import { create, deleteByIds, type DictionaryTypeVo, list, save } from '~/base/api/dictionaryType.ts'
...
const model = ref<DictionaryTypeVo>({} as DictionaryTypeVo)
