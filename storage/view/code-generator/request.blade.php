...
@php
    ...
    echo '<?php'.PHP_EOL;
    echo PHP_EOL;
    echo 'namespace App\\Http\\Admin\\Request\\'.$codeGenerator->getPackageNameFirstUp() .  ($codeGenerator->getBackendChildPath() ? '\\'.str_replace('/', '\\', $codeGenerator->getBackendChildPath()).';' : ';') . PHP_EOL;
    echo PHP_EOL;
