...
namespace App\Http\Admin\Controller\CodeGenerator;
...
use App\Http\Admin\Request\CodeGenerator\GetTableInfoRequest;
use App\Http\Admin\Request\CodeGenerator\PreviewAndGeneratorRequest;
use App\Http\Admin\Request\CodeGenerator\SaveTableSettingRequest;
use App\Http\Admin\Vo\CodeGenerator\TableColumn;
use App\Service\CodeGenerator\GeneratorService;
...
class IndexController extends AbstractController
{
    ...
    #[Get(
        path: '/admin/code-generator/get-table-info',
        operationId: 'CodeGeneratorGetTableInfo',
        summary: '获取表信息',
        tags: ['代码生成器'],
    )]
    ...
    #[Get(
        path: '/admin/code-generator/database/{databaseConnection}',
        operationId: 'CodeGeneratorGetDatabaseTableList',
        summary: '获取数据库表列表',
        tags: ['代码生成器'],
    )]
    ...
    #[Post(
        path: '/admin/code-generator/save-table-setting',
        operationId: 'CodeGeneratorSaveTableSetting',
        summary: '保存表设置',
        tags: ['代码生成器'],
    )]
    ...
    #[Get(
        path: '/admin/code-generator/table-setting/{databaseConnection}/{tableName}',
        operationId: 'CodeGeneratorGetTableSetting',
        summary: '获取表设置',
        tags: ['代码生成器'],
    )]
    ...
    #[Post(
        path: '/admin/code-generator/preview-table',
        operationId: 'CodeGeneratorPreviewTable',
        summary: '预览生成的代码',
        tags: ['代码生成器'],
    )]
    ...
    #[Post(
        path: '/admin/code-generator/generator',
        operationId: 'CodeGeneratorGenerator',
        summary: '生成代码',
        tags: ['代码生成器'],
    ...
    #[Get(
        path: '/admin/code-generator/dictTypes',
        operationId: 'dictTypes',
        summary: '获取字典列表',
        tags: ['获取字典列表'],
    )]
    public function getDictTypes(): Result
    {
        return $this->success($this->dictService->getDicts());
    }
}