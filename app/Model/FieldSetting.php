...
use App\Model\Enums\SearchTypeEnum;
 ...
 * @property string $form_dicts_name
...
final class FieldSetting extends Model
{
    ...
    protected array $fillable = [
        ...
        'is_query', 'is_sort', 'query_type', 'permission', 'form_component', 'form_component_name', 'form_component_config','form_dicts_name','i18n'
    ];
