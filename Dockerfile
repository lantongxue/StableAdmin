...
LABEL maintainer="StableAdmin" version="1.0" license="Apache 2.0" app.name="StableAdmin"
...
RUN set -ex && \
    ...
    php82-pear php82-gmp php82-dev php82-tokenizer php82-fileinfo php82-simplexml php82-xmlwriter \
...
RUN composer install --no-dev -o && cp .env.example .env.dev && cp .env.example .env.prod && php bin/hyperf.php
